                        ...
                        <div class="card-body">
                            <div class="mb-4 form-outline">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ old('nama_pelanggan', $Data->nama_pelanggan) }}" name="nama_pelanggan" id="nama_pelanggan" class="form-control @error('nama_pelanggan') is-invalid @enderror" placeholder="Masukkan Nama Pelanggan..."/>
                            ...
                            <div class="mb-4 form-outline">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="alamat" id="" cols="10" rows="3" class="form-control @error('alamat') is-invalid @enderror" placeholder="Masukkan Alamat Pelanggan...">{{$Data->alamat}}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
